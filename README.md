...
<head>
    ...
    <title>Документация за Билетния центът: Добре дошли в документацията на Билетния център</title>
        ...
        <div class="PageDoc">
            <div class="header">
                <div class="headertitle">
                    <div class="title">Добре дошли в документацията на Билетния център </div>
                </div>
            </div>
            <!--header-->
            <div class="contents">
                <div class="textblock">
                    <p>
                        <a class="anchor" id="md_Resource_Doxygen"></a>
                    </p>
                    <h1>
                    ...
                    <div style="display:inline-block; width:100%;">
                        ...
                        <img src="_client_8cpp__incl.png" />
                    </div>
                    <div style="display:inline-block; width:100%;">
                        <ul>
                            <li>
